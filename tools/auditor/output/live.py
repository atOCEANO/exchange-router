...
def _build_columns():
    return (
        ...
        TextColumn("[green]pass {task.fields[passed]:>3}[/green]"),
        TextColumn("[yellow]warn {task.fields[warned]:>3}[/yellow]"),
        TextColumn("[red]fail {task.fields[failed]:>3}[/red]"),
        TextColumn("[dim]skip {task.fields[skipped]:>3}[/dim]"),
        TextColumn("[dim]|[/dim]"),
